...
* @returns {Promise<any>}
*/
  publishDocument(document: any): Promise<any>;
/**
...
* @returns {Promise<any>}
*/
  publishDiff(message_id: string, diff: DocumentDiff): Promise<any>;
/**
...
* @returns {Promise<any>}
*/
  publishJSON(index: string, data: any): Promise<any>;
/**
* @param {string} did
* @returns {Promise<any>}
*/
...
* @returns {Promise<any>}
*/
  resolveHistory(did: string): Promise<any>;
/**
...
* @returns {Promise<any>}
*/
  resolveDiffHistory(document: Document): Promise<any>;
/**
...
*/
  diff(other: Document, message: string, key: KeyPair): DocumentDiff;
/**
* Verifies a `DocumentDiff` signature and merges the changes into `self`.
* @param {DocumentDiff} diff
*/
  merge(diff: DocumentDiff): void;
/**
...
* @returns {Array<any>}
*/
  integrationChainData(): Array<any>;
/**
...
* @returns {Array<any>}
*/
  integrationChainSpam(): Array<any>;
/**
