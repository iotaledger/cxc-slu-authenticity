...
describe('AppController (e2e)', () => {
  ...
  it('/prove (GET)', async () => {
    let { status, body } = await request(app.getHttpServer())
      .get('/identity/prove?did=did:iota:4xCZnoUYakpLYzSWXjwiebYp6RpiUi8DvD9DwoU3qe335sdd&from=2022-01-27&to=2022-01-28');
  ...
  it('/prove (GET - Invalid time value)', async () => {
    let { status, body } = await request(app.getHttpServer())
      .get('/identity/prove?did=did:iota:4xCZnoUYakpLYzSWXjwiebYp6RpiUi8DvD9DwoU3qe335sdd&from=202201-27&to=2022-01-28');
  ...
  it('/prove (GET - Empty list)', async () => {
    let { status, body } = await request(app.getHttpServer())
      .get('/identity/prove?did=did:iota:4xCZnoUYakpLYzSWXjwiebYp6RpiUi8DvD9DwoU3qe335sdd&from=2022-01-25&to=2022-01-25');
  ...
  it('/prove (GET - should return two entries)', async () => {
    let { status, body } = await request(app.getHttpServer())
      .get('/identity/prove?did=did:iota:4xCZnoUYakpLYzSWXjwiebYp6RpiUi8DvD9DwoU3qe335sdd&from=2022-01-27&to=2022-01-29');
