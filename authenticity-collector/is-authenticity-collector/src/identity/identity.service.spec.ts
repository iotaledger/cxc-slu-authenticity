...
describe('IdentityService', () => {
  ...
  it('should fail saving wrong identity', async () => {
    ...
    try {
      ...
      expect(ex.message).toBe("Identity validation failed: _id: Cast to ObjectId failed for value \"did:iota:2xCZnoUYakpLYzSWXjwiebYp6RpiUi8DvD9DwoU3qe335sdd\" (type string) at path \"_id\"")
    }
  });
  ...
  it('should fail to return return saved devices: Invalid time value', async () => {
    await new identityModel(body).save();
